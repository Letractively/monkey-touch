...
Class Game12Screen Extends Screen
	...
	Method InitGraphics:Void()
		game.images.Load("game12/title3.png","g12Title",False)
		game.images.Load("game12/wall.png","g12Wall",True)
		game.images.Load("game12/floor.png","g12Floor",True)
		game.images.Load("game12/hidden.png","g12Hidden",True)
		game.images.Load("game12/player.png","g12Player",True)
		game.images.Load("game12/ustair.png","g12UStair",True)
		game.images.Load("game12/dstair.png","g12DStair",True)
		game.images.Load("game12/heart.png","g12Heart",True)
		game.images.Load("game12/sword.png","g12Sword",True)
		game.images.Load("game12/shield.png","g12Shield",True)
		game.images.Load("game12/gold.png","g12Gold",True)
		game.images.Load("game12/battle.png","g12Battle",True)
		game.images.Load("game12/heal.png","g12Heal",True)
		game.images.Load("game12/unknown.png","g12Unknown",True)
		game.images.Load("game12/temple.png","g12Temple",True)
		game.images.Load("game12/crown.png","g12Crown",True)
		game.images.Load("game12/goldbar.png","g12GoldBar",True)
		game.images.Load("game12/food.png","g12Food",True)
		game.images.Load("game12/shovel.png","g12Shovel",True)
		game.images.Load("game12/bolt.png","g12Bolt",True)
		game.images.Load("game12/explosion.png","g12Explosion",True)
		game.images.Load("game12/fireball.png","g12Fireball",True)
		game.images.Load("game12/poison.png","g12Poison",True)
		game.images.Load("game12/punji.png","g12Punji",True)
		game.images.Load("game12/pit.png","g12Pit",True)
		game.images.Load("game12/skull.png","g12Skull",True)
		game.images.Load("game12/splat.png","g12Splat",True)
		game.images.Load("game12/miss.png","g12Miss",True)
		game.images.Load("game12/healbutton.png","g12HealButton",True)
		game.images.Load("game12/digbutton.png","g12DigButton",True)
		game.images.Load("game12/exitbutton.png","g12ExitButton",True)
		game.images.Load("game12/orc.png","g12Orc",True)
		game.images.Load("game12/spider.png","g12Spider",True)
		game.images.Load("game12/goblin.png","g12Goblin",True)
		game.images.Load("game12/giant.png","g12Giant",True)
		game.images.Load("game12/ghost.png","g12Ghost",True)
		game.images.Load("game12/staffman.png","g12Fighter",True)
		game.images.Load("game12/beholder.png","g12Beholder",True)
		game.images.Load("game12/reddragon.png","g12RedDragon",True)
		game.images.Load("game12/roc.png","g12Roc",True)
		game.images.Load("game12/bee.png","g12Bee",True)
		game.images.Load("game12/skeleton.png","g12Skeleton",True)
		game.images.Load("game12/bat.png","g12Bat",True)
		game.images.Load("game12/plant.png","g12Plant",True)
		game.images.Load("game12/wolf.png","g12Wolf",True)
		game.images.Load("game12/ooze.png","g12Ooze",True)
	...
	Method LoadGraphics:Void()
		Game12Gfx.Title = game.images.Find("g12Title")
		Game12Gfx.Wall = game.images.Find("g12Wall")
		Game12Gfx.Floor = game.images.Find("g12Floor")
		Game12Gfx.Hidden = game.images.Find("g12Hidden")
		Game12Gfx.Player = game.images.Find("g12Player")
		Game12Gfx.Heart = game.images.Find("g12Heart")
		Game12Gfx.StairsUp = game.images.Find("g12UStair")
		Game12Gfx.StairsDown = game.images.Find("g12DStair")
		Game12Gfx.Sword = game.images.Find("g12Sword")
		Game12Gfx.Shield = game.images.Find("g12Shield")
		Game12Gfx.Gold = game.images.Find("g12Gold")
		Game12Gfx.Battle = game.images.Find("g12Battle")
		Game12Gfx.Heal = game.images.Find("g12Heal")
		Game12Gfx.Unknown = game.images.Find("g12Unknown")
		Game12Gfx.Temple = game.images.Find("g12Temple")
		Game12Gfx.Crown = game.images.Find("g12Crown")
		Game12Gfx.GoldBar = game.images.Find("g12GoldBar")
		Game12Gfx.Food = game.images.Find("g12Food")
		Game12Gfx.Shovel = game.images.Find("g12Shovel")
		Game12Gfx.Bolt = game.images.Find("g12Bolt")
		Game12Gfx.Explosion = game.images.Find("g12Explosion")
		Game12Gfx.Fireball = game.images.Find("g12Fireball")
		Game12Gfx.Poison = game.images.Find("g12Poison")
		Game12Gfx.Punji = game.images.Find("g12Punji")
		Game12Gfx.Pit = game.images.Find("g12Pit")
		Game12Gfx.Skull = game.images.Find("g12Skull")
		Game12Gfx.Splat = game.images.Find("g12Splat")
		Game12Gfx.SmashSplat = game.images.Find("g12SmashSplat")
		Game12Gfx.Miss = game.images.Find("g12Miss")
		Game12Gfx.SmashButton = game.images.Find("g12SmashButton")
		Game12Gfx.HealButton = game.images.Find("g12HealButton")
		Game12Gfx.DigButton = game.images.Find("g12DigButton")
		Game12Gfx.ExitButton = game.images.Find("g12ExitButton")
		Game12Gfx.Orc = game.images.Find("g12Orc")
		Game12Gfx.Spider = game.images.Find("g12Spider")
		Game12Gfx.Goblin = game.images.Find("g12Goblin")
		Game12Gfx.Giant = game.images.Find("g12Giant")
		Game12Gfx.Ghost = game.images.Find("g12Ghost")
		Game12Gfx.Bee = game.images.Find("g12Bee")
		Game12Gfx.Fighter = game.images.Find("g12Fighter")
		Game12Gfx.Beholder = game.images.Find("g12Beholder")
		Game12Gfx.RedDragon = game.images.Find("g12RedDragon")
		Game12Gfx.Roc = game.images.Find("g12Roc")
		Game12Gfx.Skeleton = game.images.Find("g12Skeleton")
		Game12Gfx.Bat = game.images.Find("g12Bat")
		Game12Gfx.Plant = game.images.Find("g12Plant")
		Game12Gfx.Wolf = game.images.Find("g12Wolf")
		Game12Gfx.Ooze = game.images.Find("g12Ooze")
		Game12Gfx.Wand = game.images.Find("g12Wand")
	End Method
...
Class Player Extends Entity
	...
	Method ClickRelativeDir:Bool(dir:Int, checkMouse:Bool = True)
		...
		Local mX:Int, mY:Int
		mX = Int(game.mouseX / TILE_SIZE)
		mY = Int(game.mouseY / TILE_SIZE)
